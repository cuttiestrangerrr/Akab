...
<head>
    ...
    <title>Daftar - AkabDev</title>
    @vite('resources/css/app.css')
</head>
<body class="bg-neutral-900 text-white min-h-screen flex items-center justify-center">

    <div class="w-full max-w-md bg-neutral-800 p-8 rounded-xl border border-neutral-700 shadow-2xl my-10">
        ...
        <form action="{{ url('/register') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-neutral-300">Nama Lengkap</label>
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-neutral-300">Konfirmasi Password</label>
                <input type="password" name="password_confirmation" required
                    class="w-full px-4 py-2 bg-neutral-700 border border-neutral-600 rounded-lg focus:outline-none focus:border-red-600 text-white placeholder-neutral-400">
            </div>

            <button type="submit" 
                class="w-full py-3 bg-gradient-to-r from-red-700 to-red-800 hover:brightness-110 rounded-lg font-bold transition mt-4">
                Daftar
            </button>
        ...
        <p class="mt-6 text-center text-sm text-neutral-400">
            Sudah punya akun? <a href="{{ url('/login') }}" class="text-red-500 hover:underline">Masuk</a>
        </p>
    </div>
